...
export class BaseTableList {
    constructor(id: any, config?: BaseTableListConfigInterface);
    position: PositionInterface;
    tableSubject: SubjectInterface;
    addChild(child: BaseTable, targetIndex?: number): void;
    createTable(id?: any, config?: DefaultConfigInterface): BaseTable;
